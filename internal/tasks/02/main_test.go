...
func TestCalculateGamePower(t *testing.T) {
	t.Run("Game 1", func(t *testing.T) {
		...
		assert.Equal(t, gameNumber, 1)
		assert.Equal(t, gamePower, 48)
	})
	...
	t.Run("Game 2", func(t *testing.T) {
		...
		assert.Equal(t, gameNumber, 2)
		assert.Equal(t, gamePower, 12)
	})
	...
	t.Run("Game 3", func(t *testing.T) {
		...
		assert.Equal(t, gameNumber, 3)
		assert.Equal(t, gamePower, 1560)
	})
